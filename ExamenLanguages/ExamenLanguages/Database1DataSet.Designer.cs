...
namespace ExamenLanguages {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string Имя, string Фамилия, int Номер) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int Номер {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Номер\' в таблице \'Table\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsНомерNull() {
                return this.IsNull(this.tableTable.НомерColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetНомерNull() {
                this[this.tableTable.НомерColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ExamenLanguages.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Номер = 1 AND [Номер] IS NULL) OR ([Номер] = @Original_Номер)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Имя], [Фамилия], [Номер]) VALUES (@Id, @Имя, @Ф" +
                "амилия, @Номер);\r\nSELECT Id, Имя, Фамилия, Номер FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Имя] = @Имя, [Фамилия] = @Фамилия, [Номер] = @Номер WHERE (([Id] = @Original_Id) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Номер = 1 AND [Номер] IS NULL) OR ([Номер] = @Original_Номер)));
SELECT Id, Имя, Фамилия, Номер FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ExamenLanguages.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Имя, Фамилия, Номер FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Имя, string Original_Фамилия, global::System.Nullable<int> Original_Номер) {
        ...
        public virtual int Insert(int Id, string Имя, string Фамилия, global::System.Nullable<int> Номер) {
        ...
        public virtual int Update(int Id, string Имя, string Фамилия, global::System.Nullable<int> Номер, int Original_Id, string Original_Имя, string Original_Фамилия, global::System.Nullable<int> Original_Номер) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Имя, string Фамилия, global::System.Nullable<int> Номер, int Original_Id, string Original_Имя, string Original_Фамилия, global::System.Nullable<int> Original_Номер) {
            return this.Update(Original_Id, Имя, Фамилия, Номер, Original_Id, Original_Имя, Original_Фамилия, Original_Номер);
        }
    }
